...
const rejectLoginRequest = async (event, context) => {
  try {
    ...
    return Common.response(true, "Login request rejected successfully", 1, {
      requestId: loginRequest.id,
      userId: loginRequest.userId,
      user: loginRequest.user,
      rejectedBy: event.user.userId,
      rejectionReason: reason || 'No reason provided',
      rejectedAt: new Date()
...
module.exports = { handler: rejectLoginRequest };